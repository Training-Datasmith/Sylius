...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.token', TokenPaymentRequestHandler::class)
        ->args([
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.token.capture')
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.token.authorize')
        ->parent('sylius_payum.command_handler.payment_request.token')
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.model', ModelPaymentRequestHandler::class)
        ->args([
            service('sylius.provider.payment_request'),
            service('sylius_payum.resolver.payment_request.doctrine_proxy_object'),
            service('sylius_payum.processor.payment_request.request'),
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.model.status')
    ...
    $services
        ->set('sylius_payum.command_handler.payment_request.model.notify')
        ->parent('sylius_payum.command_handler.payment_request.model')
        ->args([service('sylius_payum.factory.get_status')])
