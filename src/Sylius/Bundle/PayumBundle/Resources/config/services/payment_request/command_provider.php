...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_payum.command_provider.payment_request.offline', PayumActionsCommandProvider::class)
    ...
    $services
        ->set('sylius_payum.command_provider.payment_request.offline.capture', CaptureCommandProvider::class)
        ->tag('sylius_payum.command_provider.payment_request.offline', ['action' => 'capture'])
    ;

    $services
        ->set('sylius_payum.command_provider.payment_request.offline.status', StatusCommandProvider::class)
        ->tag('sylius_payum.command_provider.payment_request.offline', ['action' => 'status'])
    ;

    $services
        ->set('sylius_payum.command_provider.payment_request.offline.notify', NotifyCommandProvider::class)
