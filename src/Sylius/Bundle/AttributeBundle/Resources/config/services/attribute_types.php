...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.attribute_type.text', TextAttributeType::class)
    ...
    $services
        ->set('sylius.attribute_type.textarea', TextareaAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.checkbox', CheckboxAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.integer', IntegerAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.float', FloatAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.percent', PercentAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.datetime', DatetimeAttributeType::class)
        ->tag('sylius.attribute.type', [
    ...
    $services
        ->set('sylius.attribute_type.date', DateAttributeType::class)
        ->tag('sylius.attribute.type', [
            'attribute_type' => 'date',
            'label' => 'Date',
    ...
    $services
        ->set('sylius.form.type.attribute_type.select', SelectAttributeFormType::class)
        ->args([service('sylius.translation_locale_provider')])
        ->tag('form.type')
    ;

    $services
        ->set('sylius.form.type.attribute_type.configuration.select_attribute_choices_collection', SelectAttributeChoicesCollectionType::class)
        ->tag('form.type')
    ;

    $services
        ->set('sylius.form.type.attribute_type.configuration.select_attribute_value_translations', SelectAttributeValueTranslationsType::class)
        ->args([service('sylius.translation_locale_provider')])
        ->tag('form.type')
    ;
};
