...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.checker.order_shipping_method_selection_requirement', OrderShippingMethodSelectionRequirementChecker::class)
    ...
    $services
        ->set('sylius.checker.order_payment_method_selection_requirement', OrderPaymentMethodSelectionRequirementChecker::class)
    ...
    $services
        ->set('sylius.checker.promotion_coupon.channel_eligibility', PromotionCouponChannelEligibilityChecker::class)
        ->tag('sylius.promotion_coupon_eligibility_checker')
    ;

    $services
        ->set('sylius.checker.shipping_method.zone_eligibility', ZoneEligibilityChecker::class)
