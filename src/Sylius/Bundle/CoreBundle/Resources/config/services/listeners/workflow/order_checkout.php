...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.listener.workflow.order_checkout.process_cart', ProcessCartListener::class)
    ...
    $services
        ->set('sylius.listener.workflow.order_checkout.apply_create_transition_on_order', ApplyCreateTransitionOnOrderListener::class)
    ...
    $services
        ->set('sylius.listener.workflow.order_checkout.save_checkout_completion_date', SaveCheckoutCompletionDateListener::class)
        ->tag('kernel.event_listener', ['event' => 'workflow.sylius_order_checkout.completed.complete', 'priority' => 300])
    ;

    $services
        ->set('sylius.listener.workflow.order_checkout.resolve_order_checkout_state', ResolveOrderCheckoutStateListener::class)
    ...
    $services
        ->set('sylius.listener.workflow.order_checkout.resolve_order_payment_state', ResolveOrderPaymentStateListener::class)
