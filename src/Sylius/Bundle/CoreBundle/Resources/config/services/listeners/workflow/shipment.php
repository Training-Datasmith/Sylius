...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.listener.workflow.shipment.resolve_order_shipment_state', ResolveOrderShipmentStateListener::class)
    ...
    $services
        ->set('sylius.listener.workflow.shipment.assign_shipping_date', AssignShippingDateListener::class)
