...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.fixture.locale', LocaleFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.currency', CurrencyFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.geographical', GeographicalFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.payment_method', PaymentMethodFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.shipping_category', ShippingCategoryFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.shipping_method', ShippingMethodFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.catalog_promotion', CatalogPromotionFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.channel', ChannelFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.customer_group', CustomerGroupFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.shop_user', ShopUserFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.admin_user', AdminUserFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product_association_type', ProductAssociationTypeFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product_association', ProductAssociationFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.similar_product_association', SimilarProductAssociationFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product_option', ProductOptionFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product_attribute', ProductAttributeFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product_review', ProductReviewFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.tax_category', TaxCategoryFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.tax_rate', TaxRateFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.promotion', PromotionFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.taxon', TaxonFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.product', ProductFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.order', OrderFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.address', AddressFixture::class)
        ->args([
    ...
    $services
        ->set('sylius.fixture.payment', PaymentFixture::class)
        ->args([
