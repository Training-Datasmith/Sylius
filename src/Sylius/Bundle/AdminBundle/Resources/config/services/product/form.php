...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_admin.form.type.product_associations', ProductAssociationsType::class)
        ->args([service('sylius_admin.form.type.data_transformer.products_to_product_associations')])
        ->tag('form.type')
    ;

    $services
        ->set('sylius_admin.form.type.data_transformer.products_to_product_associations', ProductsToProductAssociationsTransformer::class)
        ->args([
