...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_admin.twig.component.dashboard.pending_action.count_orders_to_process', PendingActionCountComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.dashboard.pending_action.count_pending_payments', PendingActionCountComponent::class)
        ->args([
            service('sylius.repository.channel'),
    ...
    $services
        ->set('sylius_admin.twig.component.dashboard.pending_action.count_product_reviews_to_approve', PendingActionCountComponent::class)
        ->args([
            service('sylius.repository.channel'),
    ...
    $services
        ->set('sylius_admin.twig.component.dashboard.pending_action.count_product_variants_out_of_stock', PendingActionCountComponent::class)
        ->args([
            service('sylius.repository.channel'),
    ...
    $services
        ->set('sylius_admin.twig.component.dashboard.pending_action.count_shipments_to_ship', PendingActionCountComponent::class)
        ->args([
            service('sylius.repository.channel'),
