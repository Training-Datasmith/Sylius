...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_admin.twig.component.admin_user.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.catalog_promotion.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.channel.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.country.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.currency.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.customer.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.customer_group.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.exchange_rate.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.locale.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.payment_method.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.product.generate_product_variants_form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.product_association_type.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.product_review.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.shipping_category.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.shipping_method.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.tax_category.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.tax_rate.form', ResourceFormComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.shared.navbar.notifications', NotificationsComponent::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.twig.component.shared.navbar.shop_preview', ShopPreviewComponent::class)
        ->args([service('sylius.repository.channel')])
        ->tag('sylius.twig_component', ['key' => 'sylius_admin:navbar:shop_preview'])
    ;

    $services
        ->set('sylius_admin.twig.component.shared.navbar.user_dropdown', UserDropdownComponent::class)
        ->args([
            service('router'),
