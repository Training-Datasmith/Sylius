...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_admin.console.command.create_admin_user', CreateAdminUserCommand::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.console.command.change_admin_user_password', ChangeAdminUserPasswordCommand::class)
        ->args([
    ...
    $services
        ->set('sylius_admin.context.locale.admin_based', AdminBasedLocaleContext::class)
        ->args([service('security.token_storage')])
        ->tag('sylius.context.locale', ['priority' => 128])
    ;

    $services
        ->set('sylius_admin.section_resolver.admin_uri_based', AdminUriBasedSectionResolver::class)
    ...
    $services
        ->set('sylius_admin.provider.logged_in_admin_user', LoggedInAdminUserProvider::class)
        ->args([
