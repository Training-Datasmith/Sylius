...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_api.query_handler.get_customer_statistics', GetCustomerStatisticsHandler::class)
        ->args([
    ...
    $services
        ->set('sylius_api.query_handler.get_statistics', GetStatisticsHandler::class)
        ->args([
