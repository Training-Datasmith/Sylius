...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_api.validator.unique_shop_user_email', UniqueShopUserEmailValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.order_not_empty', OrderNotEmptyValidator::class)
        ->args([service('sylius.repository.order')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_validator_order_not_empty'])
    ;

    $services
        ->set('sylius_api.validator.order_product_eligibility', OrderProductEligibilityValidator::class)
        ->args([service('sylius.repository.order')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_validator_order_product_eligibility'])
    ;

    $services
        ->set('sylius_api.validator.order_item_availability', OrderItemAvailabilityValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.order_shipping_method_eligibility', OrderShippingMethodEligibilityValidator::class)
        ->args([
            service('sylius.repository.order'),
    ...
    $services
        ->set('sylius_api.validator.checkout_completion', CheckoutCompletionValidator::class)
        ->args([
            service('sylius.repository.order'),
    ...
    $services
        ->set('sylius_api.validator.chosen_shipping_method_eligibility', ChosenShippingMethodEligibilityValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.adding_eligible_product_variant_to_cart', AddingEligibleProductVariantToCartValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.changed_item_quantity_in_cart', ChangedItemQuantityInCartValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.correct_order_address', CorrectOrderAddressValidator::class)
    ...
    $services
        ->set('sylius_api.validator.order_payment_method_eligibility', OrderPaymentMethodEligibilityValidator::class)
        ->args([service('sylius.repository.order')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_order_payment_method_eligibility'])
    ;

    $services
        ->set('sylius_api.validator.chosen_payment_method_eligibility', ChosenPaymentMethodEligibilityValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.can_payment_method_be_changed', CanPaymentMethodBeChangedValidator::class)
        ->args([service('sylius.repository.order')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_validator_can_payment_method_be_changed'])
    ;

    $services
        ->set('sylius_api.validator.correct_change_shop_user_confirm_password', CorrectChangeShopUserConfirmPasswordValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_correct_change_shop_user_confirm_password'])
    ;

    $services
        ->set('sylius_api.validator.confirm_reset_password', ConfirmResetPasswordValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_confirm_reset_password'])
    ;

    $services
        ->set('sylius_api.validator.promotion_coupon_eligibility', PromotionCouponEligibilityValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.shipment_already_shipped', ShipmentAlreadyShippedValidator::class)
        ->args([service('sylius.repository.shipment')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_shipment_already_shipped'])
    ;

    $services
        ->set('sylius_api.validator.shop_user_reset_password_token_exists', ShopUserResetPasswordTokenExistsValidator::class)
    ...
    $services
        ->set('sylius_api.validator.shop_user_reset_password_token_not_expired', ShopUserResetPasswordTokenNotExpiredValidator::class)
        ->args([
            service('sylius.repository.shop_user'),
    ...
    $services
        ->set('sylius_api.validator.shop_user_not_verified', ShopUserNotVerifiedValidator::class)
        ->args([service('sylius.repository.shop_user')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_shop_user_not_verified'])
    ;

    $services
        ->set('sylius_api.validator.shop_user_verification_token_eligibility', ShopUserVerificationTokenEligibilityValidator::class)
        ->args([service('sylius.repository.shop_user')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_validator_shop_user_verification_token_eligibility'])
    ;

    $services
        ->set('sylius_api.validator.single_value_for_product_variant_option', SingleValueForProductVariantOptionValidator::class)
        ->tag('validator.constraint_validator', ['alias' => 'sylius_api_validator_single_value_for_product_variant_option'])
    ;

    $services
        ->set('sylius_api.validator.unique_reviewer_email', UniqueReviewerEmailValidator::class)
        ->args([
            service('sylius.repository.shop_user'),
    ...
    $services
        ->set('sylius_api.validator.admin_reset_password_token_non_expired', AdminResetPasswordTokenNonExpiredValidator::class)
        ->args([
    ...
    $services
        ->set('sylius_api.validator.chosen_payment_request_action_eligibility', ChosenPaymentRequestActionEligibilityValidator::class)
        ->args([
            service('sylius.repository.payment_method'),
    ...
    $services
        ->set('sylius_api.validator.order_address_requirement', OrderAddressRequirementValidator::class)
        ->args([service('sylius.repository.order')])
        ->tag('validator.constraint_validator', ['alias' => 'sylius_order_address_requirement_validator'])
    ;

    $services
        ->set('sylius_api.validator.groups_generator.shipping_method_configuration', ShippingMethodConfigurationGroupsGenerator::class)
    ...
    $services
        ->set('sylius_api.validator.groups_generator.payment_method', PaymentMethodGroupsGenerator::class)
    ...
    $services
        ->set('sylius_api.validator.update_cart_email_not_allowed', UpdateCartEmailNotAllowedValidator::class)
        ->args([
            service('sylius.repository.order'),
            service('sylius_api.context.user.token_based'),
        ])
    ...
    $services
        ->set('sylius_api.validator.placed_order_cart_items_immutable', PlacedOrderCartItemsImmutableValidator::class)
        ->args([service('sylius.repository.order')])
