...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius_api.section_resolver.admin_api_uri_based', AdminApiUriBasedSectionResolver::class)
        ->args(['%sylius.security.api_admin_route%'])
        ->tag('sylius.uri_based_section_resolver', ['priority' => 30])
    ;

    $services
        ->set('sylius_api.section_resolver.shop_api_uri_based', ShopApiUriBasedSectionResolver::class)
        ->args([
