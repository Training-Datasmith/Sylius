...
return static function (ContainerConfigurator $container): void {
    ...
    $services
        ->set('sylius.custom_repository.tree.taxon', TaxonTreeRepository::class)
    ...
    $services
        ->set('sylius.repository.tree.taxon', NestedTreeRepository::class)
        ->args([
    ...
    $services
        ->set('sylius.repository.nested_tree.taxon', NestedTreeRepository::class)
        ->args([
            service('doctrine.orm.entity_manager'),
            inline_service(ClassMetadata::class)
                ->args(['%sylius.model.taxon.class%'])
